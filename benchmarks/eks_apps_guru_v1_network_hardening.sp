...
benchmark "nsa_cisa_v1_network_hardening_cpu_limit" {
  title       = "2.1 Containers should have a CPU limit to prevent resource conflicts"
...
benchmark "nsa_cisa_v1_network_hardening_cpu_request" {
  title       = "2.2 Containers should have a CPU request"
...
benchmark "nsa_cisa_v1_network_hardening_api_serve_on_secure_port_endpoint" {
  title       = "2.3 Kubernetes API should serve on secure port"
...
benchmark "nsa_cisa_v1_network_hardening_memory_limit" {
  title       = "2.4 Containers should have a memory limit"
...
benchmark "nsa_cisa_v1_network_hardening_memory_request" {
  title       = "2.5 Containers should have a memory request"
...
benchmark "nsa_cisa_v1_network_hardening_default_deny_network_policy" {
  title       = "2.6 Network policy should have a default policy to deny all ingress and egress traffic"
